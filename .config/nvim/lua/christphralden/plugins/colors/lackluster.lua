...
local function lackluster_tokyo_colors()
  return {
    red = "#aa6666",
    black = "#424242",
    gray1 = "#575757",
...
local function lackluster_tokyo_config()
  local tokyo = lackluster_tokyo_colors()
  return {
    tweak_colors = {
      black = tokyo.black,
      gray1 = tokyo.gray1,
...
lackluster.setup(lackluster_tokyo_config())
-- lackluster.setup({
--   tweak_background = {
--     normal = 'none',   -- main background
--     -- normal = 'none',    -- transparent
